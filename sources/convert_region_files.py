...
from sources.mclinear import write_region_linear_v2, open_region_anvil, write_region_anvil, open_region_linear_v2
...
def convert_file(args):
    ...
    try:
        if conversion_mode == "linear2mca":
            ...
            write_region_linear_v2(destination_file, region, compression_level=compression_level)
